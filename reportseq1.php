...
$result=mysql_query($query);
		 ...
		 ?>
		  ...
		  <div style="margin:auto; width:740px; height:920px; ">
		 <div style="float:left; width:370px;  height:920px;">
		 <div style="float:left; width:370px;  height:920px;">
		 
		 <div style="float:left; width:350px;  height:920px;">
		 <?php include 'tophalf1.php';?>
