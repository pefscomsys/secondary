...
<form method="post" action="graph/html/mggsss.php">
<div id="form" style="width: 1300px; border:0px;">
    <div class="w2ui-page page-0">
        <div style="width: 580px; float: left; margin-right: 0px;">
            <div style="padding: 3px; font-weight: bold; color: #777;"> Import and export data</div>
            <a href="lp2.php"><div style="padding: 3px; width:220px; height:47px; background:#fff; font-weight: bold; color: #777; ">
			
		<div style="float:left; margin-top:13px; margin-left:15px;">		Import Marks
</div></div></a>
       ...
       <a href="lp18.php"><div style="padding: 3px;  margin-top:3px;width:220px; height:47px; background:#fff; font-weight: bold; color: #777; ">
				<div style="float:left; margin-top:13px; margin-left:15px;">		Import Names of student
</div>
</div></a>
       ...
       <a href="lp19.php"><div style="padding: 3px;  margin-top:3px;width:220px; height:47px; background:#fff; font-weight: bold; color: #777; ">
			
				<div style="float:left; margin-top:13px; margin-left:15px;">		Import Finance
</div>
</div></a>
       ...
       <a href="download2.php"><div style="padding: 3px;  margin-top:3px;width:220px; height:47px; background:#fff; font-weight: bold; color: #777; ">
			
				<div style="float:left; margin-top:13px; margin-left:15px;">		Download names (Excell)
</div>
</div></a>
       ...
       <a href="download.php"><div style="padding: 3px;  margin-top:3px;width:220px; height:47px; background:#fff; font-weight: bold; color: #777; ">
			
				<div style="float:left; margin-top:13px; margin-left:15px;">		Download marks (Excell)
</div>
</div></a>
       ...
       <a href="download.php"><div style="padding: 3px;  margin-top:3px;width:220px; height:47px; background:#fff; font-weight: bold; color: #777; ">
				...
				<div style="float:left; margin-top:13px; margin-left:15px;">		Download Finance (Excell)
</div>
</div></a>
