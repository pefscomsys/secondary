...
echo "<script>alert('$end Successful!');</script>";
...
<input type="hidden" size="4" name="rollss[]" value="<?PHP echo $rollss;?>">
 ...
 <td style="float:left;width:50px;background:#fff;text-align:right;">TOTALD</td>
   ...
   <td style="float:left;width:50px;background:#fff;text-align:right;">Penalty</td>
...
$qry = mysql_query("select  extra3	 as total
...
?>">
 ...
 <input type="hidden" size="3" name="monthsp" readonly='readonly'value="<?php
$month=date('m');
$mxc11e=$month;
