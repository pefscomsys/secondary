...
width="100%" height="470" src="<?php  
 $mxc11UI=$levels;
if(empty($mxc11UI)){

 ECHO $statusfbiomxc11UI="none.php";}
elseif($mxc11UI>='19' && $mxc11UI<='19'){

 ECHO $statusfbiomxc11UI="poops.php"; 
}
...
elseif($mxc11UI>='8' && $mxc11UI<='8'){

 ECHO $statusfbiomxc11UI="none.php"; 
}

elseif($mxc11UI>='6' && $mxc11UI<='6'){

 ECHO $statusfbiomxc11UI="none.php"; 
}elseif($mxc11UI>='5' && $mxc11UI<='5'){
