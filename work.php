...
$user_name=$notes;
if(@$_SESSION['userlevel']!=13){header("location: login.php?error=Unauthorized access");}
...
<?php } ?>
 ...
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu2 where extra='1'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu2 where extra='2'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php } ?><?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu2 where extra='3'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php } ?><?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu2 where extra='4'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php } ?><?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu2 where extra='5'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php } ?><?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu2 where extra='6'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php } ?><?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu2 where extra='7'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php } ?><?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu2 where extra='8'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php } ?><?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu2 where extra='9'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu2 where extra='10'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
width="100%" height="470" src="work1.php?roll=<?php echo $ids;?>"
