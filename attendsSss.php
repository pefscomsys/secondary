...
<div style="width:1450px;FLOAT:left; text-align:left;text-transform:uppercase;">

</b>
<div style="width:1450px;FLOAT:left; height:30px;"><div style="float:left;width:150px;height:30px;">
Course: </div><div style="width:1200px;height:30px;"> <?php 

$department=$_POST["department"];

$week=$_POST["week"];
$sex=$_POST["sex"];$months=$_POST["months"];
echo $courses=$_POST["coursses"];


?>
</div>
<div style="float:left;width:1450px;FLOAT:left; height:30px;">
<div style="float:left;width:150px;height:30px;">
Course Desc.:</div><div style="float:left;width:1200px;height:30px;"> <?php 

$qry = mysql_query("select  db1 as total
from subject where subject='$courses'  "); 
...
<div style="width:2450px;FLOAT:LEFT;COLOR:#000;MARGIN-TOP:50PX;height:800px;;">
...
from attendance where   fname='$mats' and department='$department' and db1='$take'  and month='$months'  AND levels='$levels' AND levels='$levels' and course='$courses' "); 
$row = mysql_fetch_assoc($qry); 
 echo $x11g=$row['total']; 
...
from countat where   department='$department'  and months='$months'  AND levels='$levels' and course='$courses' "); 
$row = mysql_fetch_assoc($qry); 
 $x11gg1=$row['total']; 
