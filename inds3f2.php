...
{
	//the su
	//get all the subjects that the student does.
...
?>
		 ...
		 <div style="color: #000; float:left; font-family:arial; padding:3px; font-size:16px; text-align:center;background:#ccc; opacity:1; width:40px; height:35px; border-right:1px solid #fff; margin-left:0px;">
<?php 
if($ca == '' && $exam == ''){
	echo "";
...
?>
 ...
 <div style="float:left; width:140px; height:75px;text-align:center; font-size: 11px;">
