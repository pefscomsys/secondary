...
Track Activities
	...
	<a href="addnewcols.php?roll=<?php echo $ids;?>">
	<div style="float:left;margin-left:5px;
  ...
  width: 150px;
  height: 25px;">
  <i class="fa  fa-lastfm-square fa-2x" style="float:left; color:#50a3a2; ;">
...
width="100%" height="280px" src="sidebysideformss.php?roll=<?php echo $ids;?>"
