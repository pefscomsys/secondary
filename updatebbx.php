...
$search=$_POST["search"];
$flag=0;
$query="select * from trans where  studentname like '%$search%'  and studentname>''  order by studentname ASC ";
$result=mysql_query($query);
$i=0;
 while ($row = mysql_fetch_array($result)) {
if($i%2==0)
...
<td style="text-transform:uppercase;"><?php echo $row["accountn"]; ?></td>
<td style="text-transform:uppercase;"><?php echo $row["studentname"]; ?></td>
<td><?php echo $row["amount"]; ?></td>
<td><?php echo $row["date"]; ?></td>
<td><?php echo $row["receipt"]; ?></td>
<td>
<a href="fakeall.php?roll=<?php echo $row["roll"]; ?>">delete</a></td>
</tr></a>
<?php
$i++;
}
