...
$form=$_POST["form"];
$query="select * from courses where  matricule='$mss' and levels='$levels' and db1='$take'
";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<div style="float:left;width:705px; height:21px;">&nbsp;<b>Higher Institute of Commerce and Management (HICM)</b></div>
		 ...
		 <div style="float:left;width:949px;margin-top:15px; height:49px;border-top:1px solid #000;border-left:1px solid #000;border-right:1px solid #000;">
				
		 <div style="float:left;width:949px;text-align:center; FONT-SIZE:12PX;height:25px;border-bottom:1px solid #000;">
			1<sup>st</sup> SEMESTER
			
			</div>
			 <div style="float:left;width:950px;MARGIN-LEFT:-1PX;MARGIN-TOP:-2PX;text-align:center; FONT-SIZE:12PX;height:25px;border-bottom:1px solid #000;">
			
			 <div style="float:left;width:100px;HEIGHT:25PX;TEXT_ALIGN:CENTER;BORDER-RIGHT:1PX SOLID #000;MARGIN-TOP:1PX;">
			 <b>CODE
			</div>
						 <div style="float:left;width:470px;HEIGHT:24PX;TEXT_ALIGN:CENTER;BORDER-RIGHT:1PX SOLID #000;MARGIN-TOP:1PX;">
			 TITLE
			</div>
			
			<div style="float:left;width:60px;HEIGHT:24PX;TEXT_ALIGN:CENTER;BORDER-RIGHT:1PX SOLID #000;MARGIN-TOP:1PX;">
			 CREDIT
			</div>
			<div style="float:left;width:60px;HEIGHT:24PX;TEXT_ALIGN:CENTER;BORDER-RIGHT:1PX SOLID #000;MARGIN-TOP:1PX;">
			 MARK
			...
			<div style="float:left;width:50px;HEIGHT:24PX;TEXT_ALIGN:CENTER;BORDER-RIGHT:1PX SOLID #000;MARGIN-TOP:1PX;">
			GP
			</div>
			<div style="float:left;width:80px;HEIGHT:24PX;TEXT_ALIGN:CENTER;BORDER-RIGHT:1PX SOLID #000;MARGIN-TOP:1PX;">
			 WEIGHTED
			</div>
			<div style="float:left;width:60px;HEIGHT:24PX;TEXT_ALIGN:CENTER;MARGIN-TOP:1PX;">
			 AVERAGE</b>
			</div>
...
$query = mysql_query("select  * from resit where db1='$take' and matricule='$mats' and departmet='$deptt' and sex='1' and levels='$level'order by fname ASC"); 
		 ...
		 ?>
			 ...
			 <div style="float:left;width:99px;HEIGHT:24PX;text-align:CENTER;BORDER-left:1PX SOLID #000;BORDER-RIGHT:1PX SOLID #000;MARGIN-TOP:1PX;">
	 <div style="float:left;width:99px; margin-top:5px;">	<?php echo $courseps=$row['fname'];
		...
		$cas=$row['c101'];?>
						 ...
						 <div style="float:left;width:470px;HEIGHT:24PX;BORDER-RIGHT:1PX SOLID #000;MARGIN-TOP:1PX;">
...
?>
			...
			<div style="float:left;width:60px;HEIGHT:24PX;text-align:CENTER;BORDER-RIGHT:1PX SOLID #000;MARGIN-TOP:1PX;">
...
mysql_query ($query33) or die ('could not updated:'.mysql_error());
 ...
 ?>
			...
			<div style="float:left;width:50px;HEIGHT:24PX;text-align:CENTER;BORDER-RIGHT:1PX SOLID #000;MARGIN-TOP:1PX;">
		 <div style="float:left;width:50px; margin-top:5px;"> <?php echo $statusfbio;
		  ...
		  ?></div>
			...
			<div style="float:left;width:80px;HEIGHT:24PX;text-align:CENTER;BORDER-RIGHT:1PX SOLID #000;MARGIN-TOP:1PX;">
	 <div style="float:left;width:80px; margin-top:5px;">	  <?php echo $mkikiki=($statusfbio*$richooTTTy);
		  ...
		  ?></div>
			...
			<div style="float:left;width:59px;HEIGHT:24PX;text-align:CENTER;MARGIN-TOP:1PX;"> 
...
mysql_query ($query13r4) or die ('could not updated:'.mysql_error());
		 ...
		 <div style="float:left;width:949px; MARGIN-LEFT:-1PX;HEIGHT:24PX;border-left:1px solid #000;border-right:1px solid #000;">
...
if(empty($mxc111yt)){
 ...
 printf("%01.2f",($statusfbioopt/$statusfbioop2t));
		 ...
		 <div style="float:left;width:949px; height:49px;MARGIN-LEFT:-1PX;border-left:1px solid #000;border-right:1px solid #000;">
		 ...
		 <div style="float:left;width:949px;text-align:center; FONT-SIZE:12PX;height:25px;border-bottom:1px solid #000;">
			2<sup>ND</sup> SEMESTER
			 ...
			 <div style="float:left;width:100px;HEIGHT:24PX;TEXT_ALIGN:CENTER;BORDER-RIGHT:1PX SOLID #000;MARGIN-TOP:1PX;">
			 CODE
			</div>
						 <div style="float:left;width:470px;HEIGHT:24PX;TEXT_ALIGN:CENTER;BORDER-RIGHT:1PX SOLID #000;MARGIN-TOP:1PX;">
			 TITLE
...
$row = mysql_fetch_assoc($qry); 
 echo $tyts4=$row['total']; 
		 ...
		 <div style="float:left;width:949px; MARGIN-LEFT:-1PX;HEIGHT:24PX;border-left:1px solid #000;border-right:1px solid #000;">
			 ...
			 <div style="float:left;width:100px;HEIGHT:24PX;TEXT_ALIGN:CENTER;MARGIN-TOP:1PX;">
...
$query = mysql_query("select  * from resit where db1='$take' and matricule='$mats' and departmet='$deptt' and sex='3' and levels='$level' order by fname ASC limit 1"); 
		 ...
		 ?>
		 <div style="float:left;width:949px;FONT-WEIGHT:NORMAL; height:49px;MARGIN-LEFT:-1PX;border-left:1px solid #000;border-right:1px solid #000;">
...
$query = mysql_query("select  * from resit where db1='$take' and matricule='$mats' and departmet='$deptt' and sex='3' and levels='$level' order by fname ASC limit 1"); 
		 ...
		 <div style="float:left;width:949px; MARGIN-LEFT:-1PX;HEIGHT:24PX;border-left:1px solid #000;border-right:1px solid #000;">
			 ...
			 <div style="float:left;width:99px;HEIGHT:24PX;TEXT_ALIGN:CENTER;BORDER-RIGHT:1PX SOLID #000;MARGIN-TOP:1PX;">
			
			</div>
						 <div style="float:left;width:470px;HEIGHT:24PX;TEXT-ALIGN:RIGHT;BORDER-RIGHT:1PX SOLID #000;MARGIN-TOP:1PX;">
			<B>TOTAL<B>
			</div>
...
$row = mysql_fetch_assoc($qry); 
 echo $tyts4=$row['total']; 
			...
			<div style="float:left;width:63px;HEIGHT:24PX;TEXT_ALIGN:CENTER;MARGIN-TOP:1PX;">
...
?>
		 ...
		 <div style="float:left;width:949px; HEIGHT:150PX;  margin-top:51px;">
		 
		 <div style="float:left;width:500px; HEIGHT:150PX; "> 
		 
		 <div style="float:left;width:450px;border:1px solid #000;HEIGHT:110PX; ">
		 
		 
		 <div style="float:left;width:250px;border-right:1px solid #000;HEIGHT:100PX;font-size:12px;font-family:arial; ">
		...
		<?php echo $rangx7;?> - <?php echo $rangx8;?> %
		 ...
		 <div style="float:left;width:240px;margin-top:-100px; margin-left:260px;HEIGHT:100PX;TEXT-ALIGN:CENTER;font-size:11px; ">
		 
		  <div style="float:left;width:200px;height:18PX;TEXT-ALIGN:center;font-family:times;">
		 &nbsp;&nbsp;&nbsp;&nbsp;<u>Degree Classification</u></DIV>
	 <div style="float:left;width:200px;HEIGHT:10PX;TEXT-ALIGN:left;">GPA Class of Degree</DIV>
	 <div style="float:left;width:200px;HEIGHT:10PX;TEXT-ALIGN:left;">3.60-4.00 First Class</DIV>
	 <div style="float:left;width:200px;HEIGHT:10PX;TEXT-ALIGN:left;">3.00-3.59 Second Class-UD</DIV>
	
	 <div style="float:left;width:200px;HEIGHT:10PX;TEXT-ALIGN:left;">2.50-2.99 Second Class-LD</DIV>
	 
	 <div style="float:left;width:200px;HEIGHT:10PX;TEXT-ALIGN:left;">2.25-2.49 Third Class</DIV>
	 
	 <div style="float:left;width:200px;HEIGHT:10PX;TEXT-ALIGN:left;">2.00-2.24 Pass</DIV>
	 
	 
	 
	 <div style="float:left;width:200px;HEIGHT:10PX;TEXT-ALIGN:left;">UP (Upper Division )</DIV>
	 
	 <div style="float:left;width:200px;HEIGHT:10PX;TEXT-ALIGN:left;">LD (Lower Division )</DIV>
		 ...
		 <div style="float:left;width:400px;text-align:center; margin-left:500px; margin-top:-150px;  HEIGHT:150PX; "> 
