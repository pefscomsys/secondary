...
$form=$_POST["form"];
$query="select * from marks where form='$take' and last_name='$classes' and roll='$rolls' order by mxc20 ASC";
$result=mysql_query($query);
		 ...
		 ?><div class="page">
		  <div style="margin:auto; width:670px; height:1200px;background:url(reportss.png);margin-left:100px; ">
		 ...
		 <div style="float:left;font-family:arial;text-align:center; width:198px; height:20px;background:#efefef;border-right:1px solid #000;margin-top:3px; margin-left:0px;">
...
$query = mysql_query("select  * from resit where form='$take' and first_name='$fname' and classes='$classes' and c105='2' order by subject ASC"); 
		 ...
		 <div style="float:left;font-family:arial;text-align:left;font-size:16px; padding:4px;width:189px;text-transform:uppercase; height:35px;border-right:1px solid #ccc; margin-left:0px;">
...
echo $colors;?>;  width:40px; height:35px;border-right:1px solid #ccc;padding:3px;font-size:18px;  margin-left:0px;">
		 <?php
...
elseif($mxc10<10){
 ...
 $statusflabour="F";
 echo'<div style=" color:'. $colorf1labour.';">'.$statusflabour.'</div>';
}else if(($mxc10 >=10) && ($mxc10< 12)){
 $colorf1labour="blue";
 $statusflabour="C";
echo'<div style=" color:'. $colorf1labour.';">'.$statusflabour.'</div>';}else if(($mxc10 >=12) && ($mxc10< 14)){
 $colorf1labour="blue";
 $statusflabour="C+";
...
?>	 </div>
<div style="float:left;font-family:arial;text-align:center;padding:3px; font-size:16px; width:70px; height:35px; margin-left:0px;">
...
$class11=$row['total'];
 ?>
		 ...
		 <div style="float:left; width:196px;text-align:center; height:50px;border-right:1px solid #fff;">
		 ...
		 <div style="float:left; width:115px; height:50px;border-right:1px solid #fff;">
		...
		<b>Class AV</b>:<?php printf("%01.2f",($class11/$class1));?>
		 ...
		 <div style="float:left; width:43px; height:50px;border-right:1px solid #fff;text-align:center;">
		<b></b>
		 <?php echo $coefs;?>
		 
		 </div>

		 <div style="float:left; width:80px; height:50px;border-right:1px solid #fff;text-align:center;">
		<b>Total</b>:
		 
		 
		 </div>
 <div style="float:left; width:75px; height:50px;border-right:1px solid #fff;text-align:center;">
			 <?php echo $ctt;?>
...
elseif($uusxsd>=8.0 && $uusxsd< 10.00){
 $colorf1chem="#FF0000";
 $statusssxsd="Must work hard!";
}


elseif($uusxsd>=10 && $uusxsd< 13.00){
 $colorf1chem="#FF0000";
 $statusssxsd="Could Do better!";
}


elseif($uusxsd>=13 && $uusxsd< 15.00){
 $colorf1chem="#FF0000";
 $statusssxsd="Encourage!";
}

elseif($uusxsd>=15 && $uusxsd< 17.00){
 $colorf1chem="#FF0000";
 $statusssxsd="Satisfactory!";
}
elseif($uusxsd>=17 && $uusxsd< 18.50){
 $colorf1chem="#FF0000";
 $statusssxsd="Excellent!";
}
elseif($uusxsd>=18.50 && $uusxsd<=20){
 $colorf1chem="#FF0000";
 $statusssxsd="Credit!";
}
