...
$search=$_POST["search"];
$flag=0;
$query="select * from visitors where  fullname like '%$search%'  and fullname>''  and day='$day' and month='$month' and db1='$take'  order by fullname ASC ";
$result=mysql_query($query);
$i=0;
 while ($row = mysql_fetch_array($result)) {
if($i%2==0)
...
<td><?php echo $row["comment"]; ?></td><td>
 <a href="vvist.php?roll=<?php echo $row["roll"]; ?>">Update Record</a>
