...
document.frmUser.action = "mpcorrecst.php";
...
<div style="width:250px; float:left; height:25px; margin-left:10PX">
STUDENT NAMES</div>
...
SQ(n*2)</div><div style="width:70px; float:left; height:25px; margin-left:10PX">
coef</div>
