...
$result=mysql_query($query);
		 ...
		 ?>
		 <div class="page"><div style="margin:auto; width:670px; height:1200px;background:url(reportss.png); margin-top:-100px;margin-left:-50px;">
		 
		 <div style="float:left; width:670px; margin-top:10px; height:800px;">
		 <?php include 'topf1x.php';?></div>
...
$query = mysql_query("select  * from resit where form='$take' and first_name='$fname' and classes='$classes' and c105='1' order by subject ASC"); 
		...
		<div style="float:left;font-family:calibri;text-align:left;font-size:14px; padding:4px;width:198px;text-transform:uppercase; height:35px;border-right:1px solid #ccc; margin-left:0px;">
...
?>	 </div>
<div style="float:left;font-family:arial;text-align:center;padding:3px; font-size:18px; width:70px; height:35px; margin-left:0px;">
		<div style=" text-align:left;font-size:18px;width:200px;color:<?php echo $colorf1labour;?>;">
<?php
...
$class11=$row['total'];
 ?>
		 ...
		 <b>Moy. 1 <sup>er</sup> TRIM :<?php printf("%01.2f",$teachersport);?>
