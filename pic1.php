...
$search=$_POST["search"];
$flag=0;
$query="select * from courses where  fname like '%$search%' and db1='$take' and fname>'' order by departmet  ASC ";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
		 $flag=1;
		 echo "<tr ><td>",$row['fname'],"</td><td>&nbsp;",$row[3],"</td><td><a href='pic11.php?roll=",$row[0],"'>Change Photo with Name</a></td></tr>";
