...
Welcome to this section You can delete or modify marks here!  <?php echo $fish;?>
...
<form name="form1" action="mpcorrect.php?roll=<?php echo $fish;?>" method="post" enctype="multipart/form-data" >
...
?></select></td></tr>
  <tr>
<td>SELECT YOUR TERM</td><td><select name="coef" class="required" id="select8"style="background:#ccc;">
