...
Welcome To RESIT Page for <?php echo $subject;?>  <?php 
...
<?php } ?>			<?php
 ...
 $sql = "SELECT * FROM resit where levels='$levels' and db1='$take' and c110='$ids' and departmet='$department' and (c101+c102)<50 and fname='$subject' and matricule>'' order by matricule  ASC";
...
?>
        <div style='float:left; width:932; background:#f4f4f4; font-size:12px; color:#686868; font-family:arial; text-translevels:UPPERCASE;  '>
...
$row = mysql_fetch_assoc($qry); 
 ...
 <input type='hidden' name='sex[]' value='<?php echo $statusfbioy;?>' size='8' style='BACKGROUND:#CCC;' maxlength='4'>
 ...
 <input type='text' name='c101[]' value='<?php echo $c101;?>' size='8' style='BACKGROUND:#CCC;' maxlength='2' readonly='readonly'></div>
         <div style='float:left;width:70px; '>
 <input type='text' name='c101e[]' value='<?php echo $c102;?>' size='8' style='BACKGROUND:#CCC;' maxlength='2' readonly='readonly'></div>
        <div style='float:left;width:70px; '>
		
 <input type='<?php
$mxc11=($richooTTT1+$richooTTT2);

 if(empty($mxc11)){

 $statusfbios="";
 $statusfbio="Not Eligible";
...
elseif($mxc11<50 ){
 ...
 $statusfbios="";
 $statusfbio="Validated";
 
 $statusfbiom="1";
}
 
 ?>' name='c102[]' value='<?php echo $statusfbio;?>' size='8' style='BACKGROUND:#CCC;' maxlength='2'></div>
