...
<?php } ?>			<?php
 ...
 $sql = "SELECT * FROM resit where levels='$levels' and db1='$take' and departmet='$department' and sex='$sex' and fname='$subject' order by matricule  ASC";
...
?>
      ...
      <tr>  <td style='float:left;width:70px; '>
	<?php echo	$fname;?>
</td>
...
$row = mysql_fetch_assoc($qry); 
 ...
 <input type='text' name='c101[]' value='<?php echo $c101;?>' size='8' style='BACKGROUND:#CCC;' maxlength='2'></td>
        <td style='float:left;width:70px; '>
		
 <input type='text' name='c102[]' value='<?php echo $c102;?>' size='8' style='BACKGROUND:#CCC;' maxlength='2'></td>
