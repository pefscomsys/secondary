...
<form name="update" method="post" action="pdf/examples/seq1.php">
...
<table style=" border:1px solid silver ; background:#fff; color:#000; font-size:12px;" cellpadding="10px" bgcolor="#fff"cellspacing="0px" align="center" border="0">
    ...
    <tr>
      ...
      <td><input type="hidden" name="middle_name" size="20" value="<?php echo $row[5];?>"     readonly="readonly"></tr><tr><td></td>
	     <input type="hidden" name="classes" size="20" value="<?php echo $classes=$row['last_name'];?>"    readonly="readonly"  >
...
from resit where first_name='$first_name' and classes='$classes' and form='$take' and c101>'' and c102>'' and c105='2'  "); 
$row = mysql_fetch_assoc($qry); 
