...
<div  style="float:left;width:990px; height:540px;background:wheat;">
...
<form name="form1" action="ms111.php" method="post" enctype="multipart/form-data" >
  ...
  <tr>
    ...
    <input type="text" name="teacher"style="background:#ccc;"value="" size="34"required='requied' onBlur="doCalc(this.form)" maxlength="7"></td></tr>
   <tr><td>
