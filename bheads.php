...
<fieldset>
<legend>PRINT TRANSACTION</legend>
 ...
 <div> <input type="text" name="day" value="<?php echo $row['fname'];?>" size="8" Placeholder="day">

<input type="text" name="month" value="<?php echo $row['fname'];?>" size="8" Placeholder="month">

<input type="text" name="year" value="<?php echo $row['fname'];?>" size="8" Placeholder="year">
    ...
    <div class="w2ui-buttons">
        <button class="w2ui-btn" name="save" size="250px" style="flot:left; width:235px; height:30px;margin-left:200px;">Search Records</button>
    </div>
                </div>
				                    <div>
