...
?>
 ...
 <input type='text' name='db1[]' value='<?php echo $db1;?>'></div>     
 <div style='float:left;width:180px; '>
 <input type='text' name='subject[]' value='<?php echo $subject;?>'style='BACKGROUND:#CCC;' ></div>
  <a href="delmm.php?roll=<?php echo $roll;?>">      <div style='float:left;width:70px; '>Delete</div></a>
