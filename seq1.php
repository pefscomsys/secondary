...
<td style="height:15px;text-align:center;float:left; width:50px;font-size:12px;border-bottom:1px solid #000;">
...
<td style="height:15px;text-align:center;float:left; width:59px;font-size:12px;border-bottom:1px solid #000;">
		 ...
		 <tr>
<td style="height:18px;text-align:center;border-left:1px solid #000;border-right:1px solid #000;background:#000; color:#fff;">
...
<table style="float:left;margin-top:-5px;">
<tr>
<td style="height:18px;text-align:center;float:left; width:177px;border-right:1px solid #000;border-bottom:1px solid #000;  "><b>SQ1. AV</b>
</td>
<td style="height:18px;text-align:center;float:left; width:74px;font-size:12px;background:#efefef;border-right:1px solid #000;border-bottom:1px solid #000;">
<?php
$mxc100=$coefss;
if(empty($mxc100)){
$mxc100="";
...
<td style="height:18px;text-align:center;float:left; width:90px;font-size:12px;border-bottom:1px solid #000;">
...
<td style="height:18px;text-align:center;float:left; width:110px;font-size:12px;background:#efefef;border-right:1px solid #000;border-bottom:1px solid #000;">
<?php
...
<table style="float:left;margin-top:-5px;">
<tr>
<td style="height:15px;text-align:center;float:left; width:160px;border-right:1px solid #000;border-bottom:1px solid #000;  ">
DISCIPLINE  

</td>
<td style="height:15px;text-align:center;float:left; width:190px;border-bottom:1px solid #000;  ">
ACADEMIC WORK 
