...
<div class="row" style="background-color: white;">
    ...
    <div class="col-md-7">
        ...
        {
			$end = count($_POST['roll']);
			for($i = 0; $i < $end; $i++)
			{
				$subject = filter_post($_POST['subject'][$i]);
				$sq1 = filter_post($_POST['c101'][$i]);
				$sq2 = filter_post($_POST['c102'][$i]);
				$coef = filter_post($_POST['coef'][$i]);
				$roll = filter_post($_POST['roll'][$i]);
				
				$query = "UPDATE `resit` SET 
					`c101` = '$sq1', `c102` = '$sq2',
					`coef` = '$coef' 
						WHERE `roll` = '$roll'
						";
		...
		<div class="row">
			<div class="col-md-12">
				<div class="alert alert-success">
					...
					<button class="btn close" role="close" data-dismiss="alert">&times;</button>
				</div>
			</div>
		</div>
		<?php
        ...
        <table class="table table-condensed table-striped">
            ...
            <tr>
                ...
                <td>
                    ...
                    ?>
					<input type="hidden" value="<?php echo $row['roll']; ?>" name="roll[]" class="form-control">
					<input type="hidden" value="<?php echo $row['subject']; ?>" name="subject[]" class="form-control">
                </td>
                
				<td>
					<input type="text" value="<?php echo $row['coef']; ?>" name="coef[]" class="form-control">
				</td>
				
                <td>
                    <input type="text" value="<?php echo $row['c101']; ?>" name="c101[]" class="form-control">
                </td>
                
                <td>
                    <input type="text" value="<?php echo $row['c102']; ?>" name="c102[]" class="form-control">
                </td>
				
				<td>
                    <a href="edit_stud_marks.php?id=<?php echo $stud_id; ?>&term=<?php echo $term; ?>&del_id=<?php echo $row['roll']; ?>" 
