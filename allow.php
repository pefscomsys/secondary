...
Track Activities
	...
	<a href="addnewcolsss.php?roll=<?php echo $ids;?>">
	<div style="float:left;margin-left:5px;
  ...
  width: 180px;
  height: 25px;">
  <i class="fa  fa-toggle-off fa-2x" style="float:left; color:#50a3a2; ;">
  ...
  width: 200px;
  height: 25px;color:#50a3a2;">
  <div style="float:left;margin-top:-8px;margin-LEFT:32px;font-size:12px;">
Add New Cat
  </div>
  </div>
...
width="100%" height="280px" src="sidebysideformssss.php?roll=<?php echo $ids;?>"
...
background:#efefef;
  ...
  height: 25px;margin-top:25px; font-size:12px;color:#009933;">
