...
$result=mysql_query($query);
		 ...
		 $middle_name=$row['sport2'];
		 $paperss=$row['amount_paid2'];
		 $position=$row['mxc19'];
		 ?>
		<div class="page"><div style="margin:auto; width:670px; height:1200px;background:url(reportss.png);margin-left:-50px; margin-top:-20px;">
...
$query = mysql_query("select  * from resit where form='$take' and first_name='$fname' and classes='$classes' and c105='1' order by subject ASC"); 
		 ...
		 <div style="float:left;font-family:calibri;text-align:left;font-size:14px; padding:4px;width:150px;text-transform:uppercase; height:35px;border-right:1px solid #ccc; margin-left:0px;">
...
echo $saves=$row['total'];
	...
	<?php echo $teacher;;?></b></i>
		  ...
		  <div style="float:left;font-family:arial;text-align:center; font-size:16px;width:50px;padding:3px; height:35px;border-right:1px solid #ccc;color:<?php
$mik10=$ca;		  
if(empty($mik10)){
 $color="";
}
...
<?php echo $ca;?>
		 </div> <div style="float:left;font-family:arial;font-size:16px;text-align:center;padding:3px;  width:50px;color:<?php
$mik10s=$exam;		  
if(empty($mik10s)){
 $colors="";
}
...
<?php echo $exam;?>
		 ...
		 <div style="float:left;font-family:arial;text-align:center;font-size:16px;padding:3px; color:<?php
$mik10ss=($exam+$ca);		  
if(empty($mik10ss)){
 $colorss="";
}
...
elseif($mik10ss>=10){
 ...
 $colors;?>;  width:40px; height:35px;border-right:1px solid #ccc;padding:3px;font-size:16px;  margin-left:0px;">
		 <?php
...
?>
		 ...
		 <div style="float:left;font-family:arial;padding:3px; font-size:16px;text-align:center;background:#ccc; opacity:0.5;width:70px; height:35px;border-right:1px solid #ccc;margin-left:0px;">
...
echo $colorss;?>;text-align:center; width:70px; padding:3px;font-size:16px; height:35px;;border-right:1px solid #ccc; margin-left:0px;">
