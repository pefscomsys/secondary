...
<div class="row">
    ...
    <div class="col-md-8 col-md-offset-2">
        <div class="col-md-4">
            <a class="btn btn-info" href="add_marks_missing.php?id=<?php echo $stud_id; ?>&term=1">
                First Term
            </a>
        </div>
        <div class="col-md-4">
            <a class="btn btn-info" href="add_marks_missing.php?id=<?php echo $stud_id; ?>&term=2">
                Second Term
            </a>
        </div>
        <div class="col-md-4">
            <a class="btn btn-info" href="add_marks_missing.php?id=<?php echo $stud_id; ?>&term=3">
                Third Term
            </a>
        </div>
    </div>
