...
$_GET["roll"]=$fish;
	  ?>
<div style="float:left; width:400px;">Please Select Class for Duplicate
...
<form name="form1" action="duplicate.php?roll=<?php echo $fish;?>" method="post" enctype="multipart/form-data" >

     <table style="" cellpadding="3px"  cellspacing="0px" align="left" width="550px"style="text-transform:uppercase;">
	 
<td>SELECT TERM</td><td><select name="term" class="required" required='required'id="select8"style="background:#ccc;">
