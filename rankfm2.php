...
<div style="float:left; width:400px;text-transform:uppercase; border-left:1px solid #ccc; border-right:1px solid #ccc; border-bottom:1px solid #ccc;"><?php 
$result = mysql_query( "SELECT  * FROM marks  where last_name='$classs' and form='$take' AND fre2>0.1" )
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
$sat1=$num_rows;
...
<div style="float:left; width:400px;text-transform:uppercase; border-left:1px solid #ccc; border-right:1px solid #ccc; border-bottom:1px solid #ccc;"><?php 
$result = mysql_query( "SELECT * FROM marks where last_name='$classs' and form='$take' AND fre2>=10" )
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
...
<div style="float:left; width:400px;text-transform:uppercase; border-left:1px solid #ccc; border-right:1px solid #ccc; border-bottom:1px solid #ccc;"><?php 
$result = mysql_query( "SELECT * FROM marks where last_name='$classs' and form='$take' and first_name>'' AND fre2<10" )
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
...
<div style="float:left; width:400px;text-transform:uppercase; border-left:1px solid #ccc; border-right:1px solid #ccc; border-bottom:1px solid #ccc;"><?php 
$result = mysql_query( "SELECT  * FROM marks where last_name='$classs' and form='$take' AND fre2>=10 AND sex='M'" )
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
...
<div style="float:left; width:400px;text-transform:uppercase; border-left:1px solid #ccc; border-right:1px solid #ccc; border-bottom:1px solid #ccc;"><?php 
$result = mysql_query( "SELECT  * FROM marks where last_name='$classs' and form='$take' AND fre2>=10 AND sex='F'" )
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
...
<div style="float:left; width:400px;text-transform:uppercase; border-left:1px solid #ccc; border-right:1px solid #ccc; border-bottom:1px solid #ccc;"><?php 
$result = mysql_query( "SELECT  * FROM marks where last_name='$classs'  and form='$take'AND fre2<=5  AND sex='M'" )
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
...
<div style="float:left; width:400px;text-transform:uppercase; border-left:1px solid #ccc; border-right:1px solid #ccc; border-bottom:1px solid #ccc;"><?php 
$result = mysql_query( "SELECT * FROM marks where last_name='$classs' and form='$take' AND fre2<=5  AND sex='F'" )
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
...
<div style="float:left; width:400px;text-transform:uppercase; border-left:1px solid #ccc; border-right:1px solid #ccc; border-bottom:1px solid #ccc;"><?php 
$qry = mysql_query("select  SUM(fre2) as total
...
$sql=mysql_query("select * from marks where last_name='$classs' and form='$take' order by account2 DESC") ;
...
$table=marks;
$sql3="select * from $table    where account2='$account2' AND  last_name='$classs' and form='$take'";
$rowcount=mysql_num_rows(mysql_query($sql3));
if($rowcount==1)
{
$sql2=mysql_query("update $table     set mxc17='$i' where roll='$roll' and last_name='$classs' and form='$take' ");
mysql_query($sql2);
$i=$i+1;
}
if($rowcount>1)
...
$result = mysql_query( "SELECT matricule, first_name,last_name,fre2,account2,mxc31,mxc17 FROM $table   where last_name='$classs'  and form='$take' order by account2 DESC" )
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
