...
<?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu7 where extra='2'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php } ?><?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu7 where extra='3'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php } ?><?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu7 where extra='4'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php } ?><?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu7 where extra='5'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php } ?><?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu7 where extra='6'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php } ?><?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu7 where extra='7'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php } ?><?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu7 where extra='8'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php } ?><?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu7 where extra='9'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu7 where extra='10'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
width="100%" height="470" src="activote.php"
frameborder="0" allowFullScreen style="
 border: 0px solid #ffffff;background:#efefef;"></iframe><script type="text/javascript">
$(function () {
    $('#form').w2form({ 
        name   : 'form',
