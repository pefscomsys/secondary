...
$search=$_POST["search"];
$flag=0;
$query="select * from users where  full_name like '%$search%'  and user_level='3'";
$result=mysql_query($query);
$i=0;
 while ($row = mysql_fetch_array($result)) {
if($i%2==0)
...
<td><?php echo $mxx=$row["user_name"]; ?></td>
<td><?php echo $fv=$row["full_name"]; ?></td>
...
<td>
<a href="addsrt.php?roll=<?php echo $mxx; ?>&x=<?php echo $fv; ?>">Add Subject and Class</a>
 
 
 </td>
 <td>
<a href="view.php?roll=<?php echo $mxx; ?>&x=<?php echo $fv; ?>">View Subjects</a>
