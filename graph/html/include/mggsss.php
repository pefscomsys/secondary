...
$fname=$row["first_name"];$sex=$row["sex"];
 $mat=$row["matricule"];
$cxx2=$row["cxx2"];
$last=$row["last_name"];
$levels=$row["levels"];
...
<div id="coh1"style="font-size:12px;"><b>MINISTRY OF SECONDARY EDUCATION</b></div>

<div id="coh1"style="COLOR:rgb(20,50,100);margin-left:2px; font-size:12px;margin-top:-10px;">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;INTER COMPREHENSIVE HIGH SCHOOL BUEA



 <b style="color:red; font-size:14px;font-size:22px;">
(ICHS BUEA)</b> </div>
...
<img src="logos.png" width="90px" height="55">
</div>
...
<img src="load_image.php?pic_id=<?php echo $savep4;?>" width="130px" height="90px"style="border:1px solid #1188aa; margin-top:10px; margin-left:-25px;">
...
<div style="float:left;  width:550px; margin-top:-120px; height:65px;background:green;text-align:center;">
