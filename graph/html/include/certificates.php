...
<?php echo $deptt=$row["departmet"]; $level=$row["levels"];?>
 ...
 <div style="float:left; width:319px; height:70px;MARGIN-TOP:10PX; color:#000; text-align:center;font-weight:bold;line-height:23px; ">
		 ...
		 <div style="float:left; width:200px; height:100px;color:#000; ">
		  ...
		  <div style="float:left; font-size:18px;width:70px; height:25px;color:#000; ">
		  Signature
		 </div>
		 
		  <div style="float:left;font-size:18px; width:200px;TEXT-ALIGN:CENTER; height:65px;color:#000;MARGIN-TOP:5PX; ">
		<B>REGISTRAR</B>
		 </div>
		 </div>
		 ...
		 <div style="float:left; width:70px; font-size:18px;height:25px;color:#000; ">
		  Signature
		 </div>
		 
		  <div style="float:left; width:400px;font-size:18px;TEXT-ALIGN:CENTER; height:65px;color:#000;MARGIN-TOP:5PX; ">
...
$query = mysql_query("select  * from resit where db1='$take' and matricule='$mats' and departmet='$deptt' and sex='1' and levels='$level'  and fname>''  order by fname ASC"); 
...
$query = mysql_query("select  * from resit where db1='$take' and matricule='$mats' and departmet='$deptt' and sex='2' and levels='$level'   and fname>'' order by fname ASC"); 
