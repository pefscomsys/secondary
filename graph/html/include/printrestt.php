...
from historic where matricule='$mats'  and class='$m5' and  oldb='$take'  "); 
$row = mysql_fetch_assoc($qry); 
 $exps=$row['total']; 
...
$dates=date("Y-m-j");
$queryi="update balancesheet set g='1' where fname='$mats' and date='$dates'  ";
...
echo number_format($number, 0, '.', ',');?></i></b>
</div>
...
<div style="float:left; width:200px; height:10px;"><i>Signature of client</i>
		 ...
		 <div style='float:left;width:250px;height:25px;  margin-top:-335px;margin-left:754px;'>
<?php
$ag="10015";
$rs=$rtt+$ag;
 $matricule=$rs;
