...
<div style="float:left; width:400px;text-transform:uppercase; border-left:1px solid #ccc; border-right:1px solid #ccc; border-bottom:1px solid #ccc;"><?php 
$result = mysql_query( "SELECT  * FROM marks  where last_name='$classs' and form='$take' AND teachercivic>0.1" )
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
$sat1=$num_rows;
...
<div style="float:left; width:400px;text-transform:uppercase; border-left:1px solid #ccc; border-right:1px solid #ccc; border-bottom:1px solid #ccc;"><?php 
$result = mysql_query( "SELECT * FROM marks where last_name='$classs' and form='$take' AND teachercivic>=10" )
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
...
<div style="float:left; width:400px;text-transform:uppercase; border-left:1px solid #ccc; border-right:1px solid #ccc; border-bottom:1px solid #ccc;"><?php 
$result = mysql_query( "SELECT * FROM marks where last_name='$classs' and form='$take' and first_name>'' AND teachercivic<10" )
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
...
<div style="float:left; width:400px;text-transform:uppercase; border-left:1px solid #ccc; border-right:1px solid #ccc; border-bottom:1px solid #ccc;"><?php 
$result = mysql_query( "SELECT  * FROM marks where last_name='$classs' and form='$take' AND teachercivic>=10 AND sex='M'" )
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
...
<div style="float:left; width:400px;text-transform:uppercase; border-left:1px solid #ccc; border-right:1px solid #ccc; border-bottom:1px solid #ccc;"><?php 
$result = mysql_query( "SELECT  * FROM marks where last_name='$classs' and form='$take' AND teachercivic>=10 AND sex='F'" )
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
...
<div style="float:left; width:400px;text-transform:uppercase; border-left:1px solid #ccc; border-right:1px solid #ccc; border-bottom:1px solid #ccc;"><?php 
$result = mysql_query( "SELECT  * FROM marks where last_name='$classs'  and form='$take'AND teachercivic<=5  AND sex='M'" )
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
...
<div style="float:left; width:400px;text-transform:uppercase; border-left:1px solid #ccc; border-right:1px solid #ccc; border-bottom:1px solid #ccc;"><?php 
$result = mysql_query( "SELECT * FROM marks where last_name='$classs' and form='$take' AND teachercivic<=5  AND sex='F'" )
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
...
<br /><br /><br /><br />
<br /><br /><br /><br />
<p style="float:left;margin-left:150px; font-size:21px; ">Term Ranking</p>
<?php
...
$sql=mysql_query("select * from marks where last_name='$classs' and form='$take' order by english2 DESC") ;
...
$table=marks;
$sql3="select * from $table    where english2='$english2' AND  last_name='$classs' and form='$take'";
$rowcount=mysql_num_rows(mysql_query($sql3));
if($rowcount==1)
{
$sql2=mysql_query("update $table     set mxc21='$i' where roll='$roll' and last_name='$classs' and form='$take' ");
mysql_query($sql2);
$i=$i+1;
}
if($rowcount>1)
...
$result = mysql_query( "SELECT matricule, first_name,last_name,teachercivic,total3,mxc31,mxc21 FROM $table   where last_name='$classs'  and form='$take' order by english2 DESC" )
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
...
<p style="float:left;margin-left:150px; font-size:21px; ">Annual Average Ranking</p>
...
$sql=mysql_query("select * from marks where last_name='$classs' and form='$take' order by teacherhecon DESC") ;

while($row=mysql_fetch_assoc($sql))
{
$roll=$row['roll'];
$teacherhecon=$row['teacherhecon'];
$table="marks";
$sql3="select * from $table    where teacherhecon='$teacherhecon' AND  last_name='$classs' and form='$take'";
$rowcount=mysql_num_rows(mysql_query($sql3));
if($rowcount==1)
{
$sql2=mysql_query("update $table     set teacherecon='$i' where roll='$roll' and last_name='$classs' and form='$take' ");
mysql_query($sql2);
$i=$i+1;
}
if($rowcount>1)
...
$result = mysql_query( "SELECT matricule, first_name,last_name,teacherenglit,total3,mxc31,teacherecon FROM $table   where last_name='$classs'  and form='$take' order by english2 DESC" )
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);

print "<P>";
print "<table width=650   cellspacing=0  cellpadding='5px'><tr><td width=80  bgcolor='#efefef' ><FONT SIZE='2PX'> <font color='#000'>Matricule</FONT></td>
<td bgcolor='#efefef' ><FONT SIZE='2PX'> <font color='#000' style='text-align:left;'>Student name</FONT></td><td  bgcolor='#efefef' ><FONT SIZE='2PX'> <font color='#000'>Class</td><td bgcolor='#efefef'><FONT SIZE='2PX'><font color='#000'>Averages</td><FONT SIZE='2PX'><td bgcolor='#efefef' ><FONT SIZE='2PX'> <font color='#000'>Credit</td>
<td bgcolor='#efefef' ><FONT SIZE='2PX'> <font color='#000'>Status</td><td align='center' bgcolor='#efefef' ><FONT SIZE='2PX'> <font color='#000'>Position</font></td></tr>\n";
while ($get_info = mysql_fetch_row($result)){
print "<tr>\n";
foreach ($get_info as $field)
