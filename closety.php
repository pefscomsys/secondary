...
for($i=0;$i<count($id_array);$i++)
{
 ...
 echo "
         <div style='float:left; width:700; background:#f4f4f4; font-size:12px; color:#686868; font-family:arial; text-transform:UPPERCASE;  '>
        <div style='float:left;width:300px; '>
      <input type='hidden' name='id[]' value='$roll'></div>
        <div style='float:left;width:150px; '>
	$roll</div>
        <div style='float:left;width:100px; '>
 <input type='hidden' name='roll[]' value='$roll'></div>      <div style='float:left;width:80px; '>
 <input type='text' name='year[]' value='$year'style='BACKGROUND:#CCC;' ></div>
        <div style='float:left;width:200px; '></div><div style='float:left; width:632; border-bottom:1px solid #ccc;'></div></div></div>";
  }
