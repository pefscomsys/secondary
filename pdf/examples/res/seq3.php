...
<b style="font-size:18px;">3 <sup> rd </sup> Sequence Report</b>
...
<table style="float:left;margin-top:-5px;">
<tr>
<td style="height:18px;text-align:center;float:left; width:177px;border-right:1px solid #000;border-bottom:1px solid #000;color:#fff;  "><b>SQ3. AV</b>
</td>
