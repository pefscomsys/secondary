...
<b style="font-size:18px;">2 <sup> nd </sup> Sequence Report</b>
...
from resit where first_name='$fname'  and form='$take'  and (c101>'')  and c105='2'"); 
$row = mysql_fetch_assoc($qry); 
...
<table style="float:left;margin-top:-5px;">
<tr>
<td style="height:18px;text-align:center;float:left; width:177px;border-right:1px solid #000;border-bottom:1px solid #000;color:#fff;  "><b>SQ2. AV</b>
</td>
...
<?php
	 ...
	 $qry = mysql_query("select SUM(mxc17) as total
