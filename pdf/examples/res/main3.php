...
<img src="logo.png" width="100" height="80"style="margin-top:3px;">
</td>
...
1<sup>st</sup>Term Average :<?php printf("%01.2f",$teachersport);?><br>

		 	 <b>2<sup>nd</sup>Term Average :<?php printf("%01.2f",$teacherreligion);?></b><BR>
		 	 <b>3<sup>rd</sup>Term Average :<?php printf("%01.2f",$teachercivic);?></b>
...
<td style="height:50px;text-align:center;float:left; width:99px;border-bottom:1px solid #000;border-right:1px solid #000; ">
		...
		<b>Class AV</b>:<?php printf("%01.2f",($class11/$class1));?><br>
		Annual Av:<?php 
$t1term=$teachersport;
if(empty($t1term)){
 $statusft1term="0";
...
<td style="height:50px;text-align:center;float:left; width:230px;border-bottom:1px solid #000; ">
		...
		<b>Position -1<sup>st</sup></b>: <?php echo $position;?> out of <?php echo $class1;?><br>
		 
		 <b>Position   -2<sup>nd</sup></b>: <?php echo $position2;?> out of <?php echo $class1;?><br>
		 <b>Position-3<sup>rd</sup></b>: <?php echo $position3;?> out of <?php echo $class1;?>
