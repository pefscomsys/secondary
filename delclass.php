...
{
 $roll = $id_array[$i];
 $class = $class_array[$i];$recs= $recs_array[$i];
 $years = $years_array[$i];
...
?>
 ...
 <input type='text' name='class[]' value='<?php echo $class;?>'></div> 
        <div style='float:left;width:50px; '>
 <input type='text' name='recs[]' value='<?php echo $recs;?>'></div>     
 <div style='float:left;width:180px; '>
 <input type='text' name='year[]' value='<?php echo $years;?>'style='BACKGROUND:#CCC;'readonly='readonly' ></div>
  <a href="delmms.php?roll=<?php echo $roll;?>">      <div style='float:left;width:70px; '>Delete</div></a>
