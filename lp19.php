...
$query1="update exporttable set photo='$name1' where roll='3'";


mysql_query ($query1) or die ('could not updated:'.mysql_error());
echo "<script>alert('Update Successful!'); </script>";

 echo  $statusf="<meta http-equiv='refresh' content='0; url=note/frank3.php?usr_name=$user_name'>";
}
}
}
?>
...
<form name="form" action="lp19.php" method="POST" enctype="multipart/form-data">
<DIV style="float:left;WIDTH:550PX; height:50px; background:#ffffcc; border:1px solid #000; margin-left:50px;">

	<DIV style="float:left;WIDTH:150PX; height:50px;text-align:center;">File-import Finance</div>   
