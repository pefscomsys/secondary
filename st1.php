...
<form name="form1" action="ms1.php" method="post" enctype="multipart/form-data" >
  ...
  <tr>
    ...
    <input type="text" name="teacher"style="background:#ccc;"value="" required='requied'size="34" onBlur="doCalc(this.form)" maxlength="7"></td></tr>
   <tr><td>
