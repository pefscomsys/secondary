...
'dbc.php'
;?>
<form name="look" method="post" action="editsingle.php">
...
$search=$_POST["search"];
$flag=0;
$query="select * from marks where  first_name like '%$search%' and form='$take' and first_name>'' order by first_name ASC ";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
		 $flag=1;
		 echo "<tr ><td>",$row['first_name'],"</td><td>&nbsp;",$row[3],"</td><td><a href='buildst33.php?roll=",$row['first_name'],"'>Edit Result Slip</a></td></tr>";
