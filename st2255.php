...
Welcome To Our Edit information Page for <?php echo $subject;?><br>
Here we delete or Modify course code, semester,course ca, course exam mark if wrongly inserted<br>
1 = first semester 1,<br>
2 = second semester 2,<br>
3 = resit semester 3
...
<?php } ?>			<?php
 ...
 $sql = "SELECT * FROM resit where levels='$levels'  and db1='$take' and departmet='$department'  and fname='$subject' order by matricule ASC";
...
$sex = $sex_array[$i];
?>
        <div style='float:left; width:732; background:<?php 
$qry = mysql_query("select * FROM resit where matricule='$matricule' and fname='$fname' and departmet='$departmet' and sex='$sex' and db1='$take' "); 
...
?>;color:<?php echo $colors;?>;	 font-size:12px; height:25px; font-family:arial; text-translevels:UPPERCASE;  '>
        <div style='float:left;width:300px; '>
		
		<input type='hidden' name='id[]' value='<?php echo $roll;?>'></div>
        <div style='float:left;width:70px; '>

 <input type='text' name='fname[]' value='<?php echo $fname;?>' size='5' style='BACKGROUND:#CCC;' maxlength='4'>
</div>
 ...
 <input type='text' name='sex[]' value='<?php echo $sex;?>' size='4' style='BACKGROUND:#CCC;' maxlength='4'>
  </div>
