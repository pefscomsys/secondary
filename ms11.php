...
<form name="form1" action="ms22.php?roll=<?php echo $fish;?>" method="post" enctype="multipart/form-data" >
...
?></select></td></tr>
  <tr>
<td>SELECT YOUR COEFFICIENT HERE</td><td><select name="coef" class="required" required='required' id="select8"style="background:#ccc;">
