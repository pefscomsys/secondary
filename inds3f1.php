...
$result=mysql_query($query);
		 ...
		 $position=$row['mxc19'];$teacherhecon=$row["teacherhecon"];
		 	 $position2=$row['mxc20'];
			 	 $position3=$row['mxc21'];
		 
		 ?>
		 <div class="page">
		  <div style="margin:auto; width:670px; height:1100px;background:url(reportss.png);margin-left:0px;">
...
?>
		 ...
		 <div style="color: black; float:left;font-family:arial;padding:3px; font-size:16px;text-align:center;background:#ccc; opacity:1;width:40px; height:35px;border-right:1px solid #000;margin-left:0px;">
<?php 
...
//update the terminal average mark c106
...
from resit where form='$take' and first_name='$fname' and classes='$classes' and subject='$mss' and (c101+c102)>''    "; 
$qry=mysql_query($qryg); 
$row = mysql_fetch_assoc($qry); 
 $cax=($row['total']*2);
 echo $tm=$cax;
 */
...
?>
 ...
 <div style="float:left; width:140px; height:75px;text-align:center;">
