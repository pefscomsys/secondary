...
Track Activities
  ...
  <?php
	...
	//check if an actio has been set the do the action
	if(isset($_GET['action']))
	{
		$id = filter_post($_GET['id']);
		
		if($_GET['action'] == 'del')
		{
			//then delete the student name
			$query = "DELETE FROM `marks` WHERE `roll` = '$id' ";
...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        <h4>
			...
			<input type="hidden" value="<?php echo $class; ?>" name="class" id="class">
        ...
        <div class="table-responsive">
			<table class="table table-stripped table-bordered">
				...
				<tr>
					...
					<td>
						<button class="btn btn-danger btn-xs del" data-id1="<?php echo $row['roll']; ?>" title="Delete this Name">
							<i class="fa fa-trash"></i>
						</button>
						<a href="add_mark.php?id=<?php echo $row['roll']; ?>" title="View Marks" class="btn btn-primary btn-xs">
							<i class="fa fa-eye"></i>
						</a>
					</td>
				</tr>
	...
	<div class="col-md-12">
		<div class="text-center">
			<div class="col-md-6">
				...
				onclick="window.open('print_class.php?class=<?php echo $class; ?>&year=<?php echo $year; ?>', '', 'width=800,height=800')">
			...
			<div class="col-md-6">
				<button class="btn btn-warning"
				onclick="window.open('mark_list.php?class=<?php echo $class; ?>&year=<?php echo $year; ?>', '', 'width=800,height=800')"
				>
					<i class="fa fa-print fa-2x"></i>
					Print List for CA
				</button>
		...
		<script>
			...
			$(document).ready(function(){
				...
				$(".del").click(function(){
					...
					var clas  = $("#class").val(); //because class is a reserved word
					var year = $("#year").val();
					
					if(confirm("Are you sure you want to delete this name?? "))
					{
						//then redirect them to deleting the student name
						var url = "view_list.php?class=" + clas + "&year=" + year + "&id=" + $id + "&action=del";
