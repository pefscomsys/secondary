...
<div style="width:1103px; float:left; height:25px; background:#336600;  color:#fff;">
...
$sql = "SELECT * FROM $table  where levels='300' and departmet='BANKING AND FINANCE'";
...
for($i=0;$i<count($id_array);$i++)
{
 ...
 <input type='text' name='matricule[]' value='$matricule'placeholder='name' size='38' style='BACKGROUND:#CCC;' ></div>
   ...
   <div style='float:left;width:140px; '>
 <input type='text' name='cxx2[]' value='$cxx2'placeholder='dateof birth' size='38' style='BACKGROUND:#CCC;' ></div>
 
   <div style='float:left;width:140px; '>
 <input type='text' name='cxx1[]' value='$cxx1'placeholder='place of birth' size='38' style='BACKGROUND:#CCC;' ></div>
 ...
 </DIV><div style='float:left; width:1512px; border-bottom:1px solid #ccc;'></div>";
 }
