...
?><tr >
<td style='height:30px; background:#fff;color:#000;width:100px;'><a href="#" style='text-decoration:none;'><?php echo $row["class"];?></a></b></td>
<td style='height:30px; background:#fff;color:#000;width:100px;'><a href="#" style='text-decoration:none;'>
<?php echo $row["x"];?></a></td>
