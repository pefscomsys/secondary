...
Adding marks for Students whose names don't appear on Edit Marks
<br>
 <?php echo $fish;?>
...
<form name="form1" action="fill_marks.php" method="post" enctype="multipart/form-data" >
...
?></select></td></tr>
  <tr>
<td>SELECT YOUR TERM</td><td><select name="term" class="required" id="select8"style="background:#ccc;">
...
<tr>
<td>SELECT YOUR COEF</td><td><select name="coef" class="required" id="select8"style="background:#ccc;">
