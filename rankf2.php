...
$q = mysql_query("SELECT `year` from `rush` WHERE `roll` = '1'")
or die("Error");
...
<div style="float:left; width:400px;text-transform:uppercase; border-left:1px solid #ccc; border-right:1px solid #ccc; border-bottom:1px solid #ccc;"><?php 
$result = mysql_query( "SELECT  * FROM marks  where last_name='$classs' and form='$take' AND teacherreligion>0.1" )
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
$sat1=$num_rows;
...
<div style="float:left; width:400px;text-transform:uppercase; border-left:1px solid #ccc; border-right:1px solid #ccc; border-bottom:1px solid #ccc;"><?php 
$result = mysql_query( "SELECT * FROM marks where last_name='$classs' and form='$take' AND teacherreligion>=10" )
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
...
<div style="float:left; width:400px;text-transform:uppercase; border-left:1px solid #ccc; border-right:1px solid #ccc; border-bottom:1px solid #ccc;"><?php 
$result = mysql_query( "SELECT  * FROM marks where last_name='$classs' and form='$take' AND teacherreligion>=10 AND sex='M'" )
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
...
<div style="float:left; width:400px;text-transform:uppercase; border-left:1px solid #ccc; border-right:1px solid #ccc; border-bottom:1px solid #ccc;"><?php 
$result = mysql_query( "SELECT  * FROM marks where last_name='$classs' and form='$take' AND teacherreligion>=10 AND sex='F'" )
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
...
<div style="float:left; width:400px;text-transform:uppercase; border-left:1px solid #ccc; border-right:1px solid #ccc; border-bottom:1px solid #ccc;"><?php 
$result = mysql_query( "SELECT  * FROM marks where last_name='$classs'  and form='$take'AND teacherreligion<=5  AND sex='M'" )
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
...
<div style="float:left; width:400px;text-transform:uppercase; border-left:1px solid #ccc; border-right:1px solid #ccc; border-bottom:1px solid #ccc;"><?php 
$result = mysql_query( "SELECT * FROM marks where last_name='$classs' and form='$take' AND teacherreligion<=5  AND sex='F'" )
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
...
<br /><br /><br /><br />
<br /><br /><br /><br />
<p style="float:left;margin-left:150px; font-size:21px; ">2nd Term Ranking</p>
<?php
 $i=1;
$j=0;


$sql=mysql_query("select * from marks where last_name='$classs' and form='$take' order by middle_name DESC") ;
...
$table=marks;
$sql3="select * from $table    where middle_name='$middle_name' AND  last_name='$classs' and form='$take'";
$rowcount=mysql_num_rows(mysql_query($sql3));
if($rowcount==1)
{
$sql2=mysql_query("update $table     set mxc20='$i' where roll='$roll' and last_name='$classs' and form='$take' ");
mysql_query($sql2);
$i=$i+1;
}
if($rowcount>1)
...
$result = mysql_query( "SELECT matricule, first_name,last_name,teacherreligion,total2,mxc31,mxc20 FROM $table   where last_name='$classs'  and form='$take' order by middle_name DESC" )
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
