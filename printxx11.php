...
$result=mysql_query($query);
		 ...
		 ?><BR><div style="margin:auto; width:1308px; height:1200px; MARGIN-TOP:0PX; background:url(report.png);">
		...
		HIGHER INSTITUTE OF MANAGEMENT STUDIES <BR>(HIMS BUEA)
		P.O. BOX 462 molyko - Buea
...
STUDENT ACADEMIC RECORD
		 ...
		 <div style="float:left; width:649px; height:69px;color:#000;">
			...
			&nbsp;&nbsp;&nbsp;STUDENT NAME
			 ...
			 <div style="float:left; width:449px; height:32px;color:#000;font-size:13px;">	
...
$rs=($mx*$richooTTTy);
$query33="update resit set c104='$richooTTTy',c105='$rs'
...
$qry = mysql_query("select av as total
from average where fname='$mats' and departmet='$deptt' and levels='$level' and sex='1' and dbid='$take'  "); 
$row = mysql_fetch_assoc($qry); 
...
$qry = mysql_query("select av as total
from average where fname='$mats' and departmet='$deptt' and levels='300' and sex='1' and dbid='$take'  "); 
$row = mysql_fetch_assoc($qry); 
echo $savept=$row['total']; 
...
$qry = mysql_query("select av as total
from average where fname='$mats' and departmet='$deptt' and levels='$level' and sex='2' and dbid='$take'  "); 
$row = mysql_fetch_assoc($qry); 
echo $savept=$row['total']; 
 ?>
		    </div>
...
$qry = mysql_query("select av as total
from average where fname='$mats' and departmet='$deptt' and levels='300' and sex='2' and dbid='$take'  "); 
$row = mysql_fetch_assoc($qry); 
echo $savept=$row['total']; 
...
?>
		 ...
		 <DIV STYLE="float:left;margin-left:0px; width:60px;font-size:11px; text-align:center;height:auto;">
		   ...
		   <div style="float:left; width:400px; height:40px; margin-top:-60px;"></div> </div>
		 <?php } ?>  </div> </div> </div>
