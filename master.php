...
<p>
Please Generate Master Sheet!</p>
...
<form name="form1" action="valve.php" method="post" enctype="multipart/form-data" >
...
?></select></td></tr> <tr>
     <td style="text-transform:uppercase;">Semester(Term) </td> <td style="text-transform:uppercase;"><select name="year2" class="required" id="select8"style="background:#ccc;">
 ...
 <option value="2">Second Term</option>
      ...
      <td style="text-transform:uppercase;"style="background:#ccc;width:150px;">Academic Year</td
	  ><td>

<select name="take"style="background:#ccc;">
<?php
$rs=mysql_query("Select * from marks group by  form",$link);
	  while($row=mysql_fetch_array($rs))
{
if($row[1]==$fees)
{
