...
if($matricule!=''){
  ...
  $qryf2 = mysql_query("select tax as total  FROM  tax  where
 matricule='$matricule'  ");
...
$statusfbioff="insert tax  set  
tax='$tax' ,matricule='$matricule'";
...
?>
<form name="frmUser" method="post" action="tax.php">
<fieldset>
...
?>
 ...
 ?>" size="35">
                    ...
                    <label style="float:left;width:200px;">Tax rate:</label>
 




 <div> <input type="text" name="tax" value="" size="35">
    ...
    <div class="w2ui-buttons">
        <input class="w2ui-btn"  type="submit" value="save" name="save" size="250px" style="flot:left; width:200px; height:30px;">
    </div>
</div>
</fieldset>
