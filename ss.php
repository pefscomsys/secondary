...
date='$dates',fname='$matricule',month='$month',day='$day',xclass='$department',db1='$take',scholarship='$scholarship',status='$fname',time='$time',page='graph/html/printrestt.php'
,year='$y'";



$query55="update historic set  amount_paid='$tm',balance='$balances' where roll='$roll' and  class='$department' and oldb='$take'  ";
