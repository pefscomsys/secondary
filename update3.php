...
Class Master Section second Term

<div  style="float:left;width:990px; height:540px;background:#20deff;">
...
<form name="form1" action="updates2.php" method="post" enctype="multipart/form-data" >
