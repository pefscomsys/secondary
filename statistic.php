...
<form name="look" method="post" action="validpp.php">
...
<td colspan="4" style=" color:#fff; font-size:20px">General Performance per Department</td>
</tr>
<tr>
<td ></td>
<td>
...
<td>Semester</td><td><select name="sex" class="required" id="select8"style="background:#ccc;">
                ...
                <option value="3">Resit First semester</option>
				
                <option value="4">Resit Second semester</option>
</td></tr>
...
<tr>
<td>resit Semester course validation</td><td><select name="sexs" class="required" id="select8"style="background:#ccc;">
