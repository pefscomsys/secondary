...
'dbc.php'
;?>
<form name="look" method="post" action="st3build.php">
...
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
		 $flag=1;
		 echo "<tr ><td>",$row['first_name'],"</td><td>&nbsp;",$row[3],"</td><td><a href='buildst3.php?roll=",$row['first_name'],"'>Build Result Slip</a></td></tr>";
