...
<td>Matricule</td>
<td>Full Names</td>
<td>Contact</td><td>Enter Hours</td><td>Edit Tutor</td><td>Edit Payslip</td>
...
<td>
<a href="inotssp.php?roll=<?php echo $row["matricule"]; ?>">Enter Hours Earn</a> |

</td>
<td>

 <a href="inotsspp.php?roll=<?php echo $row["matricule"]; ?>">Edit Hours Earn</a></td>
 
 
 
<td>

 <a href="inotssppp.php?roll=<?php echo $row["matricule"]; ?>">Create Payslip Data </a> |    
 <a href="inotssppprm.php?roll=<?php echo $row["matricule"]; ?>">Edit Payslip Data </a> |           </td>
</tr></a>
<?php
$i++;
}
