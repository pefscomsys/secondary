...
<td></td>
<td>Full Names</td>
<td>Motive / Reason</td><td>Expected Amount</td>
<td>Options</td>
</tr>
<tr class="listheader">
<td></td>
...
$search=$_POST["search"];
$flag=0;
$query="select * from exm where  fname like '%$search%'  and db1='$take' order by fname ASC ";
$result=mysql_query($query);
$i=0;
 while ($row = mysql_fetch_array($result)) {
if($i%2==0)
...
<td>
<a href="inotssd.php?roll=<?php echo $row["roll"]; ?>">Update</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;| <a href="deleteu.php?roll=<?php echo $row["roll"]; ?>">Delete transaction</a></td>
</tr></a>
<?php
$i++;
}
