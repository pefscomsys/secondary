...
<form name="look" method="post" action="gather.php">
...
<td colspan="4" style=" color:#fff; font-size:20px">Generate class list</td>
</tr>
<tr>
<td ></td>
<td>
...
<select name="course">
<?php
$rs=mysql_query("Select * from  credits order by  subject ",$link);
	  while($row=mysql_fetch_array($rs))
{
if($row[1]==$fees)
{
