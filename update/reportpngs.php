...
Grade		 </div>
		 <div style="float:left;font-family:arial;text-align:center; width:50px; height:20px;background:#efefef;margin-top:3px; margin-left:0px;">
...
$query = mysql_query("select  * from resit where form='$take' and first_name='$fname' and classes='$classes' and c105='2' order by roll ASC"); 
...
$num_rows=mysql_num_rows($qry);
 ...
 ?>
		 ...
		 <div style="float:left; width:650px;font-size:13px; height:50px;background:#1188aa;color:#fff;border:1px solid #000;margin-top:1px; margin-left:1px;">


		 <div style="float:left; width:150px;text-align:center; height:50px;border-right:1px solid #000;">
		 ...
		 <div style="float:left; width:100px; height:50px;border-right:1px solid #000;">
		...
		<b>Class AV</b>:<?php printf("%01.2f",($class11/$class1));?>
		 ...
		 <div style="float:left; width:40px; height:50px;border-right:1px solid #000;text-align:center;">
		<b></b>
		 <?php echo $coefs;?>
		 
		 </div>

		 <div style="float:left; width:70px; height:50px;border-right:1px solid #000;text-align:center;">
		<b>Total</b>:
...
<div style="float:left;border:1px solid #ccc; width:20px;height:20px; background:#1188aa; color:white;"><?php echo $teacher;?></div>
  </div><div style="float:left;border:1px solid #ccc; width:120px;height:20px;font-size:13px; text-align:center;"> 
 <div style="float:left;
  width:120px;height:22px;font-size:13px; text-align:center;color:
...
?>
  ...
  <div style="float:left;
    ...
    border-radius: 14px; width:120px;height:33px;font-size:13px; text-align:center;color:
  <?php $warningf=$teacherreligion;
if(empty($warningf)){
$warningf="";
 $statussswarningf="";
