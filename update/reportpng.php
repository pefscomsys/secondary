...
$form=$_POST["form"];
$query="select * from marks where form='$take' and last_name='$classes' order by mxc19 ASC";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
		 ...
		 ?>
		 <div class="page">
		  <div style="margin:auto; width:670px; height:1000px; ">
		  <div style="float:left; width:670px; height:800px; ">
		 ...
		 <div style="float:left; width:650px;font-weight:normal; height:25px;font-size:13px;background:#ccc;border:1px solid #000;margin-top:1px; margin-left:1px;">
		 
		 
		 <div style="float:left;font-family:arial;text-align:center; width:150px; height:20px;background:#ccc;border-right:1px solid #000;margin-top:3px; margin-left:0px;">
		 
		 Subject
		 </div>
		  <div style="float:left;font-family:arial;text-align:center; width:50px; height:20px;background:#ccc;border-right:1px solid #000;margin-top:3px; margin-left:0px;">
		 
1 <sup> st</sup>Sq
		 </div> <div style="float:left;font-family:arial;text-align:center; width:50px; height:20px;background:#ccc;border-right:1px solid #000;margin-top:3px; margin-left:0px;">
		 
2 <sup> nd</sup>Sq
		 </div>
		 <div style="float:left;font-family:arial;text-align:center; width:40px; height:20px;background:#ccc;border-right:1px solid #000;margin-top:3px; margin-left:0px;">
		 
Coef.
		 </div>
		 <div style="float:left;font-family:arial;text-align:center; width:70px; height:20px;background:#ccc;border-right:1px solid #000;margin-top:3px; margin-left:0px;">
Average
		 </div>
...
Grade		 </div> 
<div style="float:left;font-family:arial;text-align:center; width:70px; height:20px;background:#ccc;margin-top:3px; margin-left:0px;">
...
elseif(($mxc10)<"10"){
	echo "<span style='color:#f00'>FIAL</span>";
}
else {
	echo "Pass";
}
...
<strong>DISCIPLINE</strong>
  ...
  <div style="float:left;border:1px solid #ccc; width:120px;height:20px;font-size:12px; text-align:center;"> 
...
<div style="float:left;border:1px solid #ccc; width:20px;height:20px; background:#1188aa; color:white;"><?php echo $date2;?></div>
  </div><div style="float:left;border:1px solid #ccc; width:120px;height:20px;font-size:13px; text-align:center;"> 
 <div style="float:left;
  width:120px;height:22px;font-size:13px; text-align:center;color:
...
C= 10-10.9
  ...
  <div style="float:left;border:1px solid #ccc; width:120px;height:33px;font-size:13px; text-align:center;"> 
Suspension in days
  </div>  <div style="float:left;border:1px solid #ccc; width:30px;height:33px;font-size:13px; text-align:center;"> 
...
?>
  ...
  <div style="float:left;border:1px solid #ccc; width:20px;height:33px;font-size:13px; text-align:center;"> 

  </div><div style="float:left;border:1px solid #ccc; width:120px;height:33px;font-size:13px; text-align:center;"> 

  <div style="float:left;
    -webkit-border-radius: 14px;
    -moz-border-radius: 14px;
    border-radius: 14px; width:120px;height:29px;font-size:13px; text-align:center;color:
  <?php $warningf=$teachersport;
if(empty($warningf)){
$warningf="";
 $statussswarningf="";
...
echo $statussswarning1
  ...
  Warning
   ...
   <div style="float:left;border:1px solid #ccc; width:75px;height:33px;font-size:13px; text-align:center;"> 
F= 0-9
  </div>
