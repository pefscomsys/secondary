...
<?php } ?>
 ...
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu55 where extra='1'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu55 where extra='2'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php } ?><?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu55 where extra='3'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php } ?><?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu55 where extra='4'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php } ?><?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu55 where extra='5'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php } ?><?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu55 where extra='6'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php } ?><?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu55 where extra='7'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php } ?><?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu55 where extra='8'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php } ?><?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu55 where extra='9'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
<?php
 $notes=$_SESSION['user_name'];
$roll=$_GET["1"];
$query="select * from mainmenu55 where extra='10'";
$result=mysql_query($query);
		 while ($row = mysql_fetch_array($result)) {
...
margin-top:100px;
 color:#fff;
  ...
  <a href="bookup.php" style="color:#fff;">
  ...
  <div style="float:left; WIDTH:85PX; HEIGHT:25PX;font-size:13px;font-weight:bold;">Admission section</div>
  ...
  <a href="biodata.php" style="color:#fff;">
  <div style="float:left; WIDTH:130PX; height25px; margin-top:10px; ">
  ...
  <div style="float:left; WIDTH:85PX; HEIGHT:25PX;font-size:13px;font-weight:bold;">Bio data</div>
  ...
  <a href="updateyyy.php" style="color:#fff;">
  <div style="float:left; WIDTH:130PX; height25px; margin-top:10px; ">
  ...
  <div style="float:left; WIDTH:80PX; HEIGHT:25PX;font-size:13px;font-weight:bold;">Update Fees </div>
...
$qry = mysql_query("select * FROM  balancesheet where g=''  and id!='5' and id!='11'"); 
...
width="100%" height="800PX" src="admission.php"
