...
//FORMER RULE FOR SHOWING COEFFFICIENT		 
$mik10ss=(($exam+$ca)/2);
$shows=$mik10ss;
/*		  
if(empty($shows)){
...
///MY OWN NEWLY CREATED RULE
//If the mark is empty then don't show the coefficient. else show it
if($exam == '' && $ca == '')
{
	//the don't show the coefficient
}
else
{
	//show it.
