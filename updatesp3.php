...
echo "<script>alert('Datae Base Updated Successful!'); window.location.href('marks.php');</script>";
 ...
 echo  $statusf="<meta http-equiv='refresh' content='0; url=rankm3.php'>"; 
 }
?>
<?php } ?>			<?php
	  /******************** ERROR MESSAGES*************************************************
...
from resit where first_name='$first_name' and classes='$classes' and form='$take' and c101>''  and c105='3'  "); 
$row = mysql_fetch_assoc($qry); 
