...
from subject2 where db1='$db1s' and subject='$subjects' and department='$classess' and year1='$coefs' and  year2='3'"); 
...
echo "<script>alert('Datae Base Updated Successful!'); window.location.href('marks.php');</script>";
 echo  $statusf="<meta http-equiv='refresh' content='0; url=resit1.php'>"; 
 }
 ?>
<?php } ?>			<?php
	  /******************** ERROR MESSAGES*************************************************
...
?>
 ...
 <input type='text' name='c101[]' value='' size='8' style='BACKGROUND:#CCC;' maxlength='2'></div>
        <div style='float:left;width:70px; '>
		
 <input type='hidden' name='c105[]' value='3' size='8' style='BACKGROUND:#CCC;' maxlength='2'>
 <input type='text' name='c102[]' value='' size='8' style='BACKGROUND:#CCC;' maxlength='2'></div>
 <input type='hidden' name='coef[]' value='<?php echo $coef;?>' size='8' style='BACKGROUND:#CCC;' maxlength='4'>
 <input type='hidden' name='c103[]' value='($c101+$c102)' size='8' style='BACKGROUND:#CCC;' maxlength='2'>
 
 <input type='hidden' name='subjects' value='<?php echo $subject;?>' size='8' style='BACKGROUND:#CCC;' maxlength='4'>
 
 <input type='hidden' name='terms' value='3' size='8' style='BACKGROUND:#CCC;' maxlength='2'>
