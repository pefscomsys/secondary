...
$query5="update visitors  set  comment='$comment',timeout='$timeout'.status='2' where roll='$ms' and db1='$take'   ";
...
$search=$_POST["search"];
$flag=0;
$query="select * from visitors where roll='$ms' ";
$result=mysql_query($query);
$i=0;
 while ($row = mysql_fetch_array($result)) {
...
<div id="form" style="width: 1300px; border:0px;">
    <div class="w2ui-page page-0">
        <div style="width: 580px; float: left; margin-right: 0px;">
            <div style="padding: 3px; font-weight: bold; color: #777;">UPDATE VISITORS REGISTER</div>
            <div class="w2ui-group" style="height: auto;">
                <div class="w2ui-field w2ui-span4">
                    <label>Full Name:</label>
                    <div>
                        <input name="fullname" type="text" value="<?php echo $row['fullname'];?>" maxlength="100" style="width: 100%" size="350px" readonly='readonly'>
                    </div>
                </div>
                ...
                <div class="w2ui-field w2ui-span4">
                    ...
                    <div>
                        <input name="idcard" type="text"  value="<?php echo $row['idcard'];?>"maxlength="100" style="width: 100%" readonly='readonly'>
                    </div>
                </div>
                ...
                <div class="w2ui-field w2ui-span4">
                    <label>Contact:</label>
                    <div>
                        <input name="contact" type="text" maxlength="100" style="width: 100%" value="<?php echo $row['contact'];?>" readonly='readonly'>
                    </div>
                </div>
				   ...
				   <div class="w2ui-field w2ui-span4">
                    <label>Timeout:</label>
                    <div>
                        <input name="timeout" type="text" maxlength="100" style="width: 100%" value="<?php echo date("H:s:i");?>" readonly='readonly'>
                    </div>
                </div>
				    <div class="w2ui-field w2ui-span4">
                    <label>Comment:</label>
    ...
    <div class="w2ui-buttons">
        <button class="w2ui-btn" name="save" size="250px">UPDATE VISITOR RECORDS</button>
    </div>
</div>
</form><?php } ?>
