...
margin-top:100px;
 color:#fff;
  ...
  <div style="float:left; WIDTH:80PX; HEIGHT:25PX;font-size:13px;font-weight:bold;"><a href=javascript:popcontact('matricul.php') style="color:#fff; font-size:14px; text-decoration:none; font-weight:bold">See Matricule</a></div>
...
width="100%" height="670" src="admission.php"
