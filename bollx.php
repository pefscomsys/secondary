...
<td style='height:30px; background:<?php
...
?>;color:#000;width:100px;'><a onclick="window.open('unisst.php?levels=<?php echo $row["class"];?>&subject=<?php echo $row["subject"];?>&user_name=<?php echo $ids;?>&term=<?php echo $row["x"];?>', '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');">
