...
$search=$_POST["search"];
$flag=0;
$query="select * from admission where  fname like '%$search%'  and fname>'' and country=''  AND status='$take'  order by fname ASC ";
$result=mysql_query($query);
$i=0;
 while ($row = mysql_fetch_array($result)) {
if($i%2==0)
...
<td>
<a href="inotss.php?roll=<?php echo $row["recid"]; ?>">Admit Student</a></td>
</tr></a>
<?php
$i++;
}
