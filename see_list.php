...
<div class="row">
	<div class="col-md-8 col-md-offset-2">
        <form class="form-horizontal" method="POST" action="view_list.php">
			<div class="form-group">
				...
				<div class="col-md-8">
					<select name="class" class="form-control">
						<?php
						echo $query = "SELECT * FROM `classes` ORDER BY class";
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<select name="year" class="form-control">
						<?php
						echo $query = "SELECT * FROM `marks` GROUP BY `form`";
						$res = mysql_query($query);
