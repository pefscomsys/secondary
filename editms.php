...
<a href="resit2.php">
<div style="float:left; width:200px;margin-toP:25px;text-align:center; border:1px solid #000; height:30px; background:#FFBB40;">CORRECTION OF MARKS</div></a>

	
<DIV Style="font-family:verdana;color:#282828:margin-top:7px;line-height:28px;font-size:13px; ">
<a href="missing_names.php">
<div style="float:left; width:200px;margin-toP:25px;text-align:center; border:1px solid #000; height:30px; background:#FFBB40;">
ADD MARKS FOR MISSING NAMES
</div></a>


	
<DIV Style="font-family:verdana;color:#282828:margin-top:7px;line-height:28px;font-size:13px; ">
<a href="st3builds.php">
<div style="float:left; width:200px;margin-toP:25px;text-align:center; border:1px solid #000; height:30px; background:#FFBB40;">ADD A  SINGLE SUB ON RESULT SLIP</div></a>

	
<DIV Style="font-family:verdana;color:#282828:margin-top:7px;line-height:28px;font-size:13px; ">
<a href="st3build.php">
<div style="float:left; width:200px;margin-toP:25px;text-align:center; border:1px solid #000; height:30px; background:#FFBB40;">BUILD SINGLE RESULT SLIP</div></a>


	
<DIV Style="font-family:verdana;color:#282828:margin-top:7px;line-height:28px;font-size:13px; ">
<a href="editsingle.php">
